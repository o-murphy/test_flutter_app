...
class Sight {
  ...
  final dynamic sightHeight;   // Distance
  final dynamic zeroElevation; // Angular
  final String? notes;
  ...
  factory Sight.fromJson(Map<String, dynamic> json) => Sight(
        ...
        sightHeight: distanceFromJson(json['sightHeight'] as Map),
        zeroElevation: angularFromJson(json['zeroElevation'] as Map),
