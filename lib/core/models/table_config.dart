...
class TableConfig {
  ...
  TableConfig copyWith({
    ...
    return TableConfig(
      ...
      spoilerShowProjectile:     spoilerShowProjectile     ?? this.spoilerShowProjectile,
      ...
      spoilerShowBulletDiam:     spoilerShowBulletDiam     ?? this.spoilerShowBulletDiam,
      spoilerShowBulletWeight:   spoilerShowBulletWeight   ?? this.spoilerShowBulletWeight,
      spoilerShowFormFactor:       spoilerShowFormFactor       ?? this.spoilerShowFormFactor,
      spoilerShowSectionalDensity: spoilerShowSectionalDensity ?? this.spoilerShowSectionalDensity,
      spoilerShowGyroStability:    spoilerShowGyroStability    ?? this.spoilerShowGyroStability,
